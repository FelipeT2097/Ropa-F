...
public class RegistrarReversiones {
    ...
    //REVERSA/ANULA una factura completamente - Genera Nota Crédito
    //(Devolución) - Devuelve stock automáticamente - Cambia estado de factura
    public int reversarFactura(int facturaId, String motivo, String usuario) {
        ...
        try {
            ...
            //GENERAR CONSECUTIVO DE NOTA CRÉDITO
            ...
            ps3.setString(5, nombreCliente);
            ps3.setString(6, numeroDocumento);
            ps3.setTimestamp(7, fechaFactura);
            ps3.setDouble(8, subtotal);
            ps3.setDouble(9, iva);
            ...
            psUpdateFactura.setString(1, motivo);
            psUpdateFactura.setInt(2, facturaId);
    ...
    public java.util.List<java.util.Map<String, Object>> obtenerHistorialReversiones(int limite) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                item.put("numero_factura_original", rs.getString("numero_factura"));
