...
public class Inventario extends javax.swing.JInternalFrame {
    ...
    public void populateJtable(String val) {
        ...
        controlador.Producto producto = new controlador.Producto();
        ArrayList<controlador.Producto> productosList = producto.productoList(val);
        String[] colNames = {"Id", "Nombre", "Precio", "Cantidad", "Talla", "Color", "Genero"};
        Object[][] rows = new Object[productosList.size()][7];

        for (int i = 0; i < productosList.size(); i++) {
            rows[i][0] = productosList.get(i).getId();
            rows[i][1] = productosList.get(i).getNombre();
            rows[i][2] = productosList.get(i).getPrecio();
            rows[i][3] = productosList.get(i).getCantidad();
            rows[i][4] = productosList.get(i).getTalla();
            rows[i][5] = productosList.get(i).getColor();
            rows[i][6] = productosList.get(i).getGenero();
        }
    ...
    private void initComponents() {
        ...
        jButton_agregar_product = new javax.swing.JButton();
        ...
        jButton_agregar_product.setBackground(new java.awt.Color(51, 102, 0));
        jButton_agregar_product.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        jButton_agregar_product.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/insert_2.png"))); // NOI18N
        jButton_agregar_product.setText("Agregar Producto");
        jButton_agregar_product.setBorder(new javax.swing.border.MatteBorder(null));
        jButton_agregar_product.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_agregar_productActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel_inventarioLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_inventarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel_inventarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(jButton_agregar_product, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel_inventarioLayout.createSequentialGroup()
                .addGroup(jPanel_inventarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel_inventarioLayout.createSequentialGroup()
                        ...
                        .addComponent(jButton_agregar_product, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void jButton_eliminar_productActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_eliminar_productActionPerformed
        try {
            ...
            controlador.Producto.eliminarProducto(id);
        } catch (Exception ex) {
    ...
    private javax.swing.JButton jButton_agregar_product;
