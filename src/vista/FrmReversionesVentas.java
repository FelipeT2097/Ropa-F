...
import controlador.RegistrarReversionesVentas;
 ...
 * @author piper
 */
public class FrmReversionesVentas extends javax.swing.JInternalFrame {

    // Controlador
    private RegistrarReversionesVentas controlador;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmReversionesVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmReversionesVentas().setVisible(true);
            }
        });
    }
