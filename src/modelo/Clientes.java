...
public class Clientes {
    ...
    public static ArrayList<Clientes> clienList() {

        ArrayList<Clientes> clienList = new ArrayList<>();
    ...
    public static void actualizarClientes(Clientes cliente) {
        Connection con = null;
        PreparedStatement ps = null;
    ...
    public static Clientes buscarClientePorNIT(String nit) {
        Clientes cliente = null;
        Connection con = ConexionDB.getConnection();

        // Ajusta el campo según tu base de datos: en tu caso es "numero_documento"
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                cliente.setTipoDocumento(rs.getString("tipo_documento_cliente"));
            ...
            Logger.getLogger(Clientes.class.getName()).log(Level.SEVERE, "Error al buscar cliente por NIT", ex);
        }
