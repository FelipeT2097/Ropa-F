...
public class Proveedores {
    ...
    public static void insertarProveedores(Proveedores proveedores) {
        Connection con = null;
    ...
    public ArrayList<Proveedores> proveeList(String prove) {
        ArrayList<Proveedores> prove_List = new ArrayList<>();
        Connection cn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public static void actualizarProveedores(Proveedores proveedores) {
        Connection con = null;
        PreparedStatement ps = null;
